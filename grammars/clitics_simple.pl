...
macro(iv, dl(0,np,s(0))).
macro(vp(I), dl(0,np,s(I))).
macro(tv, dr(0,vp(0),np)).
macro(dtv, dr(0,dr(0,iv,pp_a),np)).
macro(inf(I), dl(0,np,s(I))).
...
lex(jean, np, jean).
lex(pomme, n, pomme).
lex(livre, n, un_livre).
lex(un, dr(0,np,n), un).
lex(une, dr(0,np,n), une).
lex(des, dr(0,np,n), des).
lex(le, clitic(vp(2),vp(1),np), lambda(A,lambda(B,appl(appl(A,le),B)))).
lex(la, clitic(vp(2),vp(1),np), lambda(A,lambda(B,appl(appl(A,la),B)))).
%lex(a_jean, np_d, jean).
lex(le, dr(0,np,n), le).
lex(la, dr(0,np,n), la).
lex(les, dr(0,np,n), les).
lex(à, dr(0,pp_a,np), a).
lex(au, dr(0,pp_a,n), lambda(A,appl(a,appl(le,A)))).
lex(lui, clitic(vp(1),vp(0),pp_a), lambda(A,lambda(B,appl(appl(A,lui),B)))).
lex(me, clitic(vp(3),vp(2),pp_a), lambda(A,lambda(B,appl(appl(A,me),B)))).
lex(lire, dr(0,inf(3),np), lire).
lex(manger, dr(0,inf(3),np), manger).
...
lex(laisse, dr(0,dr(0,iv,dia(i,inf(3))),np), lambda(A,lambda(B,lambda(C,appl(appl(laisse,appl(B,A)),C))))).
lex(laisse, dr(0,dr(0,iv,np),inf(3)), lambda(A,lambda(B,lambda(C,appl(appl(laisse,appl(A,B)),C))))).
...
lex(acheté, dr(0,vp(3),np), achete).
