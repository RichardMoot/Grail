...
lex('.', dl(0,lit(s(_)),lit(txt)), Sem) :-
	semantics(dot, Sem).
lex('.', dl(0,lit(n(p)),lit(txt)), lambda(P,appl(appl(P,lambda(V,lambda(E1,drs([],[])))),_))).
...
default_semantics(W, dr(0,dl(_,lit(s(S)),lit(s(S))),lit(n(p))), lambda(P,lambda(Q,lambda(E,merge(appl(appl(P,lambda(V,lambda(E1,drs([E1],[appl(appl(W,V),E1)])))),E),appl(Q,E)))))).
default_semantics(W, dr(0,dr(_,lit(s(S)),lit(s(S))),lit(n(p))), lambda(P,lambda(Q,lambda(E,merge(appl(appl(P,lambda(V,lambda(E1,drs([E1],[appl(appl(W,V),E1)])))),E),appl(Q,E)))))).
%default_semantics(W, dr(0,dr(_,lit(s(S)),lit(s(S))),lit(n(p))), lambda(X,lambda(P,lambda(E,bool(appl(P,E),&,appl(appl(W,X),E)))))).

% lambda(P,appl(appl(P,lambda(V,lambda(E1,drs([],[])))),_)))
% = prepositions - noun modifiers
% adj_semantics(drt, Word, lambda(P,lambda(V, lambda(E,merge(drs([],[appl(Word,V)]),appl(appl(P,V),E)))))).

%lambda(P,lambda(Q,lambda(V,lambda(E,merge(appl(appl(P,lambda(V,lambda(E1,drs([E1,X],[appl(Word,E1)]))),E),c),appl(appl(Q,V),E))))))) :-
% 
default_semantics(Word, dr(0,dl(0,lit(n(N1)),lit(n(N2))),lit(n(p))), lambda(NP,lambda(N,lambda(V,lambda(E,merge(merge(drs([],[appl(appl(Word,V),E)]),appl(appl(N,V),E)),appl(appl(NP,lambda(X,lambda(E1,drs([],[])))),E)))))) :-
	var(N1),
	var(N2),
	N1 == N2.
...
default_semantics(Word, dl(_,dr(0,lit(n(N0)),lit(n(N1))),dl(_,lit(n(p)),lit(s(_)))), lambda(P,lambda(Q,appl(Q,lambda(V,appl(appl(P,lambda(W,lambda(E,drs([E,W],[appl(event,E),appl(property,W),appl(appl(appl(Word,W),V),E)])))),W)))))) :-
	var(N0),
	var(N1),
	N0 == N1.
...
default_semantics(worden, dr(_,dl(_,lit(n(p)),lit(s(_))),dl(_,lit(n(p)),lit(s(ppart)))), lambda(P,lambda(X,lambda(E,merge(appl(appl(P,_),E),drs([],[appl(appl(patient,appl(X,_)),E)])))))).
...
default_semantics(is, dr(_,dl(_,lit(n(p)),lit(s(_))),dl(_,lit(n(p)),lit(s(ppart)))), lambda(P,lambda(X,lambda(E,merge(appl(appl(P,X),E),drs([],[appl(finished,E)])))))).

default_semantics(zijn, dr(_,dl(_,lit(n(p)),lit(s(_))),dl(_,lit(n(p)),lit(s(ppart)))), lambda(P,lambda(X,lambda(E,merge(appl(appl(P,X),E),drs([],[appl(finished,E)])))))).

% = willen + inf

default_semantics(willen, dr(_,dl(_,lit(n(p)),lit(s(_))),dl(_,lit(n(p)),lit(s(inf)))), lambda(P,lambda(X,lambda(E,merge(drs([E],[appl(willen,E),appl(appl(agent,_Subj),E)),appl(appl(patient,F),E)]),appl(appl(P,X),F))))).
